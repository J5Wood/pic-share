...
function AddImage(formData) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, supabase, session, textContent, userId, username, configObj, imageRes, imageResData, _b, data, error, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _c.trys.push([2, 6, , 7]);
                    return [4 /*yield*/, fetch(url, configObj)];
                case 3:
                    imageRes = _c.sent();
                    return [4 /*yield*/, imageRes.json()];
                case 4:
                    imageResData = _c.sent();
                ...
                case 6:
                    err_1 = _c.sent();
                    console.log("Image creation error: ", err_1);
                    return [3 /*break*/, 7];
